                    ...
                    dt.javaClass.declaredFields
                        ...
                        .filter { p ->
                            ...
                            val v = when (val dtVal = p.second) {
                                null -> ""
                                is LocalDateTime -> dtVal.format(Equipment.datetimeFormatter("yyyy-MM-dd HH:mm:ss"))
                                is LocalTime -> dtVal.format(Equipment.datetimeFormatter("HH:mm:ss"))
                                is LocalDate -> dtVal.format(Equipment.datetimeFormatter("yyyy-MM-dd"))
